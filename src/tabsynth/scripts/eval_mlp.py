...
from tabsynth.tab_ddpm.modules import MLP
...
def train_mlp(
    ...
    """
    Train a Multi-Layer Perceptron (MLP) model on real and/or synthetic data.

    This function trains an MLP model on either real data, synthetic data, or a combination of both. 
    The data is loaded, preprocessed, and concatenated before training the MLP model. T
    he function also computes and returns evaluation metrics for the trained model.
    ...
    params : dict, optional, default=None
        Dictionary of MLP configuration parameters. If None, the function retrieves the MLP configuration from a predefined file path.
